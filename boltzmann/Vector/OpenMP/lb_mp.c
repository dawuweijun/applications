...
int main(int argc, char **argv){
	...
	if(checkFlag(argv, argc, "debug")){
			...
			#pragma omp parallel
			#pragma omp single
			printf("Lattice Boltzmann Method - D3Q19 - Vector - OpenMP - Threads: %d - Double Precision\n", omp_get_num_threads());
		#else
			#pragma omp parallel
			#pragma omp single
			printf("Lattice Boltzmann Method - D3Q19 - Vector - OpenMP - Threads: %d -Single Precision\n", omp_get_num_threads());
		#endif
