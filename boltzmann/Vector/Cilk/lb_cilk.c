...
int main(int argc, char **argv){
	...
	if(checkFlag(argv, argc, "debug")){
		#ifdef USE_DOUBLE
			printf("Lattice Boltzmann Method - D3Q19 - Vector - Cilk - Threads: %d - Double Precision\n", __cilkrts_get_nworkers());
		#else
			printf("Lattice Boltzmann Method - D3Q19 - Vector - Cilk - Threads: %d -Single Precision\n", __cilkrts_get_nworkers());
		#endif
